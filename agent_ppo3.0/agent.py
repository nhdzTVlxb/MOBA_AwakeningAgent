...
class Agent(BaseAgent):
    ...
    def observation_process(self, env_obs):
        ...
        """
        feature, legal_action, reward, shaped_reward, visible_treasure_ratio, distance_reward, remain_info = self.preprocessor.feature_process(env_obs, self.last_action)
