...
class Config:
    ...
    # + map(8*15*15=1800) + legal(16) + progress(24)
    FEATURES = [
        15,
        10,
        10,
    ...
    # --- 闪现奖励 ---
    FLASH_ESCAPE_REWARD_COEF = 0.008
    FLASH_DANGER_DISTANCE = 10.0
    FLASH_DIRECTION_REWARD_COEF = 0.008
    ...
    TRAPPED_FLASH_ESCAPE_BONUS = 0.55
    TRAPPED_FLASH_MONSTER_CROSS_BONUS = 0.75
    ...
    BUFF_ACCELERATION_BONUS = 0.50  # 加速增益奖励
    POST_SPEEDUP_BUFF_BONUS = 0.75  # 怪物加速后增益的奖励
