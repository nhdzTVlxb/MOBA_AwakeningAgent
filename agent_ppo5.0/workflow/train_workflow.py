...
class EpisodeMetrics:
    ...
    flash_hit_wall_penalty: float = 0.0
    first_seen_buff_reward: float = 0.0
    step_score_reward: float = 0.0
    ...
    # 新增奖励项字段
    low_pressure_explore_bonus: float = 0.0
    low_pressure_stall_penalty: float = 0.0
    safe_flash_penalty: float = 0.0
    flash_suicide_penalty: float = 0.0
    post_flash_stall_penalty: float = 0.0
    post_flash_oscillation_penalty: float = 0.0
    post_flash_hit_wall_penalty: float = 0.0
    post_flash_backtrack_penalty: float = 0.0
    post_flash_explore_bonus: float = 0.0
    normal_escape_reward: float = 0.0
    buff_approach_reward: float = 0.0
    buff_pickup_escape_combo_reward: float = 0.0
    ...
    def observe_step(self, env_obs, shaped_reward, reward_terms=None, speedup_state=None, step_idx=0):
        ...
        self.flash_hit_wall_penalty += float(reward_terms.get("flash_hit_wall_penalty", 0.0))
        self.first_seen_buff_reward += float(reward_terms.get("first_seen_buff_reward", 0.0))
        self.step_score_reward += float(reward_terms.get("step_score_reward", 0.0))
        ...
        # 新增奖励项收集
        self.low_pressure_explore_bonus += float(reward_terms.get("low_pressure_explore_bonus", 0.0))
        self.low_pressure_stall_penalty += float(reward_terms.get("low_pressure_stall_penalty", 0.0))
        self.safe_flash_penalty += float(reward_terms.get("safe_flash_penalty", 0.0))
        self.flash_suicide_penalty += float(reward_terms.get("flash_suicide_penalty", 0.0))
        self.post_flash_stall_penalty += float(reward_terms.get("post_flash_stall_penalty", 0.0))
        self.post_flash_oscillation_penalty += float(reward_terms.get("post_flash_oscillation_penalty", 0.0))
        self.post_flash_hit_wall_penalty += float(reward_terms.get("post_flash_hit_wall_penalty", 0.0))
        self.post_flash_backtrack_penalty += float(reward_terms.get("post_flash_backtrack_penalty", 0.0))
        self.post_flash_explore_bonus += float(reward_terms.get("post_flash_explore_bonus", 0.0))
        self.normal_escape_reward += float(reward_terms.get("normal_escape_reward", 0.0))
        self.buff_approach_reward += float(reward_terms.get("buff_approach_reward", 0.0))
        self.buff_pickup_escape_combo_reward += float(reward_terms.get("buff_pickup_escape_combo_reward", 0.0))
    ...
    def as_train_monitor_dict(self):
        ...
        return {
            ...
            "train_flash_hit_wall_penalty": self.flash_hit_wall_penalty,
            "train_first_seen_buff_reward": self.first_seen_buff_reward,
            "train_step_score_reward": self.step_score_reward,
            ...
            # 新增奖励项监控
            "train_low_pressure_explore_bonus": self.low_pressure_explore_bonus,
            "train_low_pressure_stall_penalty": self.low_pressure_stall_penalty,
            "train_safe_flash_penalty": self.safe_flash_penalty,
            "train_flash_suicide_penalty": self.flash_suicide_penalty,
            "train_post_flash_stall_penalty": self.post_flash_stall_penalty,
            "train_post_flash_oscillation_penalty": self.post_flash_oscillation_penalty,
            "train_post_flash_hit_wall_penalty": self.post_flash_hit_wall_penalty,
            "train_post_flash_backtrack_penalty": self.post_flash_backtrack_penalty,
            "train_post_flash_explore_bonus": self.post_flash_explore_bonus,
            "train_normal_escape_reward": self.normal_escape_reward,
            "train_buff_approach_reward": self.buff_approach_reward,
            "train_buff_pickup_escape_combo_reward": self.buff_pickup_escape_combo_reward,
        }
    ...
    def as_val_episode_dict(self):
        ...
        return {
            "reward": self.reward,
            "flash_hit_wall_penalty": self.flash_hit_wall_penalty,
            "first_seen_buff_reward": self.first_seen_buff_reward,
            "step_score_reward": self.step_score_reward,
            ...
            # 新增奖励项监控
            "val_low_pressure_explore_bonus": self.low_pressure_explore_bonus,
            "val_low_pressure_stall_penalty": self.low_pressure_stall_penalty,
            "val_safe_flash_penalty": self.safe_flash_penalty,
            "val_flash_suicide_penalty": self.flash_suicide_penalty,
            "val_post_flash_stall_penalty": self.post_flash_stall_penalty,
            "val_post_flash_oscillation_penalty": self.post_flash_oscillation_penalty,
            "val_post_flash_hit_wall_penalty": self.post_flash_hit_wall_penalty,
            "val_post_flash_backtrack_penalty": self.post_flash_backtrack_penalty,
            "val_post_flash_explore_bonus": self.post_flash_explore_bonus,
            "val_normal_escape_reward": self.normal_escape_reward,
            "val_buff_approach_reward": self.buff_approach_reward,
            "val_buff_pickup_escape_combo_reward": self.buff_pickup_escape_combo_reward,
        }
...
class EpisodeRunner:
    ...
    def _build_val_monitor_data(self, val_episode_metrics):
        ...
        return {
            ...
            # 新增监控项
            "val_low_pressure_explore_bonus": mean_metrics.get("low_pressure_explore_bonus", 0.0),
            "val_low_pressure_stall_penalty": mean_metrics.get("low_pressure_stall_penalty", 0.0),
            "val_safe_flash_penalty": mean_metrics.get("safe_flash_penalty", 0.0),
            "val_flash_suicide_penalty": mean_metrics.get("flash_suicide_penalty", 0.0),
            "val_post_flash_stall_penalty": mean_metrics.get("post_flash_stall_penalty", 0.0),
            "val_post_flash_oscillation_penalty": mean_metrics.get("post_flash_oscillation_penalty", 0.0),
            "val_post_flash_hit_wall_penalty": mean_metrics.get("post_flash_hit_wall_penalty", 0.0),
            "val_post_flash_backtrack_penalty": mean_metrics.get("post_flash_backtrack_penalty", 0.0),
            "val_post_flash_explore_bonus": mean_metrics.get("post_flash_explore_bonus", 0.0),
            "val_normal_escape_reward": mean_metrics.get("normal_escape_reward", 0.0),
            "val_buff_approach_reward": mean_metrics.get("buff_approach_reward", 0.0),
            "val_buff_pickup_escape_combo_reward": mean_metrics.get("buff_pickup_escape_combo_reward", 0.0),
            "val_flash_hit_wall_penalty": mean_metrics.get("flash_hit_wall_penalty", 0.0),
            "val_first_seen_buff_reward": mean_metrics.get("first_seen_buff_reward", 0.0),
            "val_step_score_reward": mean_metrics.get("step_score_reward", 0.0),
        }