...
def build_monitor():
    ...
    return (
        ...
        .add_panel(name="FlashHitWall", name_en="train_flash_hit_wall_penalty", type="line")
        .add_metric(
            metrics_name="train_flash_hit_wall_penalty",
            expr="avg(train_flash_hit_wall_penalty{})",
        )
        .end_panel()

        .add_panel(name="FirstSeenBuff", name_en="train_first_seen_buff_reward", type="line")
        .add_metric(
            metrics_name="train_first_seen_buff_reward",
            expr="avg(train_first_seen_buff_reward{})",
        )
        .end_panel()

        .add_panel(name="StepScoreR", name_en="train_step_score_reward", type="line")
        .add_metric(
            metrics_name="train_step_score_reward",
            expr="avg(train_step_score_reward{})",
        )
        .end_panel()
        ...
        .add_panel(name="FlashHitWall", name_en="val_flash_hit_wall_penalty", type="line")
        .add_metric(
            metrics_name="val_flash_hit_wall_penalty",
            expr="avg(val_flash_hit_wall_penalty{})",
        )
        .end_panel()

        .add_panel(name="FirstSeenBuff", name_en="val_first_seen_buff_reward", type="line")
        .add_metric(
            metrics_name="val_first_seen_buff_reward",
            expr="avg(val_first_seen_buff_reward{})",
        )
        .end_panel()

        .add_panel(name="StepScoreR", name_en="val_step_score_reward", type="line")
        .add_metric(
            metrics_name="val_step_score_reward",
            expr="avg(val_step_score_reward{})",
        )
        .end_panel()
